...
RSpec.describe Studio do
  ...
  describe 'instance methods' do
    describe '#actors_formatted' do
      it 'returns actors for a studio currently working and ordered by age' do
        expect(@studio1.actors_formatted).to eq([@actor1.name, @actor3.name, @actor5.name])
      end
    end
  end
end
